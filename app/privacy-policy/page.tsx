    ...
    return (
        ...
        <main className="flex-1 flex flex-col max-w-screen-lg w-full mx-auto px-3 py-6">
            ...
            <ul className="list-disc list-inside mb-4">
                <li><strong>Personal Information:</strong> Such as your email address, username, and other details you
                    provide during registration.
                </li>
                <li><strong>Usage Data:</strong> Information about how you interact with our app, such as pages visited,
                    bookmarks saved, and interactions with friends.
                </li>
                <li><strong>Location Data:</strong> Geolocation information if you enable location services.</li>
            </ul>
            ...
            <ul className="list-disc list-inside mb-4">
                <li><strong>Service Providers:</strong> For analytics, hosting, and other necessary services.</li>
            ...
            <ul className="list-disc list-inside mb-4">
                ...
                <li>Opt out of certain data collection or usage.</li>
            </ul>

            <h2 className="text-2xl font-semibold text-gray-800 mb-4">Data Security</h2>
            <p className="mb-4">We use industry-standard measures to protect your information. However, no method of transmission over
                the internet is 100% secure.</p>

            <h2 className="text-2xl font-semibold text-gray-800 mb-4">Children&#39;s Privacy</h2>
            <p className="mb-4">Our app is not intended for children under the age of 13, and we do not knowingly collect data from
                them.</p>

            <h2 className="text-2xl font-semibold text-gray-800 mb-4">Changes to This Policy</h2>
            <p className="mb-4">We may update this Privacy Policy from time to time. Any changes will be posted on this page with an
                updated revision date.</p>

            <h2 className="text-2xl font-semibold text-gray-800 mb-4">Contact Us</h2>
            <p className="mb-4">If you have any questions about this Privacy Policy, please contact us at <a
                href="mailto:couplewhocodes@gmail.com">couplewhocodes@gmail.com</a>.</p>
