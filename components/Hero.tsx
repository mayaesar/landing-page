...
export default function Hero(){
    ...
    return(
        <section className="flex-1 flex flex-col-reverse md:flex-row items-center justify-center gap-4 md:gap-24">
            <div className="relative w-full md:w-[280px] shrink-0 h-full">
                <img src="/phoneMock.png" alt="phone frame" className="md:absolute md:top-[10%]"/>
            </div>
            <div>
